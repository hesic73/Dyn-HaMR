...
def main(file_path: str):
    ...
    hand_orient_world = axis_angle_to_matrix(torch.from_numpy(root_orient).to(torch.float32))  # (2, T, 3, 3)
    hand_orient_world_euler = matrix_to_euler_angles(hand_orient_world, 'XYZ').numpy()  # (2, T, 3)
...
if __name__ == "__main__":
    main("/home/hsc/25fall/Dyn-HaMR/outputs/logs/video-custom/2025-09-03/demo1-all-shot-0-0-500/smooth_fit/demo1_000060_world_results.npz")
